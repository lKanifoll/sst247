...
//---------------------------------------------------------------------------------check version----------------------------------------------------
    ...
    static const char *REQUEST = "GET ""/static/firmware/firmware_equation_v2_wifi_http.xml"" HTTP/1.1\n"
    	"Host: "SERVER_IP"\n"
    	"User-Agent: ESP32\n"
    	"\n";
    char recv_buf[1000];
    	...
    	int num_bytes,i=0;
    		...
    		bzero(temp_buf_ver, sizeof(temp_buf_ver));
    			...
    			while(num_bytes)
    			{
    					...
    					if(strncmp(temp_buf_ver,version,strlen(version))==0)  	// ���� ����� version, ������������ �������� �� ����� �����
    					{
    						i+=7;												// ������ �� 7 ������ (����� ����� version)
    						bzero(temp_buf_ver, sizeof(temp_buf_ver));
    						while(1)											// ���� ������ ����� <string>
    						{
    							for(uint8_t g=0;g<8;g++)
    								temp_buf_ver[g]=recv_buf[i+g];				// ���������� ����� ������: ���������� �� ��������� ������ �� 8 �������� (����� ����� <string>)
    							if((strcmp(temp_buf_ver,"<string>"))==0)		// � ����������
    							{
    								i+=8;

    								for(uint8_t g=0;g<3;g++)
    								{
    									ver[g]=recv_buf[i+g];					// ���� �����, ����� � ������ ver �������� ����� ����� <string>
    					...
    					if(strncmp(temp_buf_ver,url,strlen(url))==0)  			// ���� ����� url, ������������ �������� �� ����� �����
    					{
    						i+=3;												// ������ �� 3 ������ (����� ����� url)
    						bzero(temp_buf_ver, sizeof(temp_buf_ver));
    						while(1)											// ���� ������ ����� <string>
